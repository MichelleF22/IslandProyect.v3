public class Zorro extends Animal {
    public Zorro (int x, int y, int vidaInicial, String especie, String nombre, EncuentroManager encuentroManager, String sexo) {
        super(
                x,
                y,
                vidaInicial,
    ...
    @Override
    public void comer() {
        System.out.println(" \uD83C\uDF56 El zorro mastica con rapidez en: (" + x + ", " + y + ")");
        vida++;
    }
